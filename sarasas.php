...
; ?> 
<form method="_GET">
<input  type="button" name="minus-pagenumber" value="<" onClick="window.location.href='https://shopabcfun.herokuapp.com/sarasas.php?page=<?php if(true){echo $page-1} ?>'"></button>
