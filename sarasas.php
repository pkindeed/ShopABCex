...
; ?> 
<form method="_GET">
<input  type="button" name="minus-pagenumber" value="<" onClick="window.location.href='https://shopabcfun.herokuapp.com/sarasas.php?page=<?php echo $_GET['page']++; ?>'"></button>
<input  type="button" name="add-pagenumber" value=">" onClick="window.location.href='https://shopabcfun.herokuapp.com/sarasas.php?page=<?php echo $_GET['page']-1; ?>'"></button></form></h3>
